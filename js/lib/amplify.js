 ...
 * http://amplifyjs.com
 */
console.log("running amplify.js");
...
amplify.request.types.ajax = function( defnSettings ) {
	...
	return function( settings, request ) {
		...
		handleResponse = function( data, status ) {
			...
			// TODO:430 something also returns "OK", what?
			if ( /OK$/.test( ampXHR.statusText ) ) {
				ampXHR.statusText = "success";
			}
			if ( data === undefined ) {
				// TODO:360 add support for ajax errors with data
				data = null;
			}
			if ( aborted ) {
				status = "abort";
			...
			// TODO:370 figure out if this breaks polling or multi-part responses
			handleResponse = $.noop;
		};
